        ...
        <section className="container my-5">
            <div className="row">
                ...
                <div className="col-md-7 col-12">
                    <div className="card">
                        <h5 className="card-header hms-bg-normal text-center">Work with Us</h5>
                        <div className="card-body">
                            ...
                            <div className="mb-3">
                                <label htmlFor="message" className="form-label">Updated CV</label>
                                <input type="file" className="form-control" placeholder="Upload Updated CV" />
                            </div>
                            <div className="mb-3">
